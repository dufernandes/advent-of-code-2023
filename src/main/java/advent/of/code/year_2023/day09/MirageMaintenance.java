...
import advent.of.code.year_2023.day08.HauntedWasteland;
...
public class MirageMaintenance {
  ...
  public static void main(String[] args) {
    try {
      ...
      //log.info("The result of part two is: {}", new MirageMaintenance().getNumberOfStepsUntilAllEndUpWithZ());
    } catch (IOException ioe) {
      log.error("error while opening input file", ioe);
    }
  }

  private long getSumOfExtrapolatedValues() throws IOException {
    long sum = 0;
